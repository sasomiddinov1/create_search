# Generated by Django 3.2.9 on 2021-12-16 12:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attends', models.ManyToManyField(blank=True, to='mainapp.MyClubUser')),
                ('venue', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mainapp.venue')),
            ],
        ),
    ]
